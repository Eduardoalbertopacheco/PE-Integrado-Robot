*** Settings ***
Documentation    Cenário: Cadastro de uma Concorrencia Eletronico por Item
...
*** Test Cases ***
CT01 - Criar Concorrência Eletrônica - Aba Dados Gerais
...
CT09 - Agendar Concorrência eletrônica
