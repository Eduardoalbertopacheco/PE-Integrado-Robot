...
$foldersPath = "${EXECDIR}\test\CRIAR_PREGAO\Fechado_aberto_lote"

# Nome do arquivo de teste
$testFileName = "Pregao_F_A_lote_01_Teste_Auto.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Pregao/Fechado_Aberto_Lote/Pregao_Fechado_Aberto_Lote_01"
