...
$foldersPath = "${EXECDIR}\test\CRIAR_PREGAO\Aberto_fechado_item"

# Nome do arquivo de teste
$testFileName = "Pregao_A_F_item_02.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Pregao/Aberto_Fechado_Item/Pregao_Aberto_Fechado_item_02"
