...
$foldersPath = "${EXECDIR}\test\CRIAR_CONCORRENCIAS\Concorrencia_fechado_aberto_item"

# Nome do arquivo de teste
$testFileName = "Concorrencia_F_A_item_01_Teste_Auto.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Concorrencia/Fechado_Aberto_Item/Conc_fechado_aberto_item_01"
