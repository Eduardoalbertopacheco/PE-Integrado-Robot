...
# $testFileName = "SC_Lote_Pregao_aberto_fechado_Teste_Auto.robot"
# $testFilePath = "${foldersPath}\$testFileName"

# if (Test-Path $testFilePath) {
#     Write-Host "Executando teste: $testFilePath"
#     robot --exitonfailure -d ./Relatorio/Solicitacao_Compra/SC_Lote_Pregao_aberto_fechado $testFilePath
# } else {
...
$reportDir = "./Relatorio/Solicitacao_Compra/SC_Lote_Pregao_Aberto_Fechado"
