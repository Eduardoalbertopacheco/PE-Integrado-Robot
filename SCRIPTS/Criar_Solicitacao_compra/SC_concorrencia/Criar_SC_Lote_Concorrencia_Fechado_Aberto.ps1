...
# $testFileName = "SC_Lote_Concorrencia_fechado_aberto_Teste_Auto.robot"
# $testFilePath = "${foldersPath}\$testFileName"

# if (Test-Path $testFilePath) {
#     Write-Host "Executando teste: $testFilePath"
#     robot --exitonfailure -d ./Relatorio/Solicitacao_Compra/SC_Lote_Concorrencia_fechado_aberto $testFilePath
# } else {
...
$reportDir = "./Relatorio/Solicitacao_Compra/SC_Lote_Concorrencia_Aberto"
