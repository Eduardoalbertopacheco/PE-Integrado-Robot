...
$foldersPath = "${EXECDIR}\test\CRIAR_PREGAO\Aberto_item_para_contrato"

# Nome do arquivo de teste
$testFileName = "Pregao_Aberto_item_02_contrato_Teste_Auto.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Pregao/Aberto_Item/Pregao_Aberto_Item_02"
