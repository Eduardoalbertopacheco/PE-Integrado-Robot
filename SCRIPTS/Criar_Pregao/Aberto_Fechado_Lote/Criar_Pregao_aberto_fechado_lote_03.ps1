...
# $testFileName = "Pregao_A_F_lote_lote_03.robot"
# $testFilePath = "${foldersPath}\$testFileName"

# if (Test-Path $testFilePath) {
#     Write-Host "Executando teste: $testFilePath"
#     robot --exitonfailure -d ./Relatorio/Pregao/Aberto_Fechado_Lote/Pregao_Aberto_Fechado_Lote_03 $testFilePath
# } else {
...
$testFileName = "Pregao_A_F_lote_03_Teste_Auto.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Pregao/Aberto_Fechado_Lote/Pregao_Aberto_Fechado_Lote_03"
