...
# $testFileName = "Conc_aberto_item_01_Teste_Auto.robot"
...
# Nome do arquivo de teste
 $testFileName = "Concorrencia_Aberto_item_01_Teste_Auto.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "../Relatorio/Concorrencia/Aberto_Item/Conc_aberto_item_01"
