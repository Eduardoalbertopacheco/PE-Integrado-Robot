...
# $testFileName = "Conc_aberto_item_03.robot"
# $testFilePath = "${foldersPath}\$testFileName"

# if (Test-Path $testFilePath) {
#     Write-Host "Executando teste: $testFilePath"
#     robot --exitonfailure -d ./Relatorio/Concorrencia/Aberto_Item/Conc_aberto_item_03 $testFilePath
# } else {
...
$testFileName = "Concorrencia_Aberto_item_03.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Concorrencia/Aberto_Item/Conc_aberto_item_03"
