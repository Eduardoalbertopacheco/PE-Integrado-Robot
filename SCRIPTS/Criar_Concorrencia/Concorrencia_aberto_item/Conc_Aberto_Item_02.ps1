...
# $testFileName = "Conc_aberto_item_02.robot"
# $testFilePath = "${foldersPath}\$testFileName"

# if (Test-Path $testFilePath) {
#     Write-Host "Executando teste: $testFilePath"
#     robot --exitonfailure -d ./Relatorio/Concorrencia/Aberto_Item/Conc_aberto_item_02 $testFilePath
# } else {
...
$reportDir = "./Relatorio/Concorrencia/Aberto_Item/Conc_aberto_item_02"
