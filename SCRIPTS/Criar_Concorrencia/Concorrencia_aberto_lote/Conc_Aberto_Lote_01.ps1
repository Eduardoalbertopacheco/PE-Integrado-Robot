...
# $testFileName = "Conc_aberto_lote_01_Teste_Auto.robot"
# $testFilePath = "${foldersPath}\$testFileName"

# if (Test-Path $testFilePath) {
#     Write-Host "Executando teste: $testFilePath"
#     robot --exitonfailure -d ./Relatorio/Concorrencia/Aberto_Lote/Conc_aberto_lote_01 $testFilePath
# } else {
...
$testFileName = "Concorrencia_Aberto_lote_01_Teste_Auto.robot"
$testFilePath = "${foldersPath}\$testFileName"

# Diretório para salvar os relatórios
$reportDir = "./Relatorio/Concorrencia/Aberto_Lote/Conc_aberto_lote_01"
